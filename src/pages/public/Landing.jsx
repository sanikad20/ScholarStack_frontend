...
function Hero() {
  return (
    <section className="pt-20">
      <div className="max-w-[1450px] mx-auto px-8 lg:px-16">
  ...
  return (
    <div className="group overflow-hidden rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-xl transition duration-300">
      ...
      >
        <svg
          viewBox="0 0 100 60"
          className="w-28 h-20 group-hover:scale-110 transition"
        >
          <rect
            x="15"
            y="24"
...
function InstitutionHighlights({
  institutions,
  status,
}) {
  return (
      ...
      <div className="max-w-[1450px] mx-auto px-8 lg:px-16">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
            Discover institutions currently accepting
            applications through ScholarStack.
          </p>
        ...
        {status === "loading" && (
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1,2,3,4].map((i)=>(
              <div
                key={i}
                className="rounded-2xl h-80 bg-gray-100 animate-pulse"
              />
            ))}
          </div>
        )}
    ...
    <section className="py-24 bg-gray-50">
      ...
      <div className="max-w-[1450px] mx-auto px-8 lg:px-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="mt-4 text-4xl font-bold">
            How ScholarStack Works
          </h2>

          <p className="mt-4 text-gray-500">
            Complete your admission journey in
            three simple steps.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300 max-w-xl">
              Join 120+ institutions already managing admissions
              through ScholarStack. Track every applicant from
              draft to admitted—all from one dashboard.
            </p>
